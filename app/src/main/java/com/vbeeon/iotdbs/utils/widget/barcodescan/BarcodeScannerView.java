...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback {
    ...
    private int mBorderMargin = getResources().getInteger(R.integer.viewfinder_border_margin);
    private int mStatusColor= getResources().getColor(R.color.viewfinder_status_color);
    private int mStatusSize=getResources().getInteger(R.integer.viewfinder_status_size);
    private int mStatusMargin= getResources().getInteger(R.integer.viewfinder_status_margin);
    private String mStatusText= getResources().getString(R.string.status_scan);
    ...
    private int mViewFinderMarginTop = 10;
    private int mViewFinderWidth = 100;
    private int mViewFinderHeight = 100;
    ...
    public BarcodeScannerView(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            mBorderMargin = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_borderMargin, mBorderMargin);
            mStatusSize = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_statusSize, mStatusSize);
            mStatusColor = a.getColor(R.styleable.BarcodeScannerView_statusColor, mStatusColor);
            mStatusMargin = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_statusMargin, mStatusMargin);
            mStatusText = a.getString(R.styleable.BarcodeScannerView_statusText);
            ...
            mViewFinderMarginTop = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_finderMarginTop, mViewFinderMarginTop);
            mViewFinderWidth = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_finderWidth, mViewFinderWidth);
            mViewFinderHeight = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_finderHeight, mViewFinderHeight);
        } finally {
            a.recycle();
        }
    ...
    protected IViewFinder createViewFinderView(Context context) {
        ...
        viewFinderView.setBorderLineMargin(mBorderMargin);
        viewFinderView.setMaskColor(mMaskColor);
        viewFinderView.setStatusSize(mStatusSize);
        viewFinderView.setStatusColor(mStatusColor);
        viewFinderView.setStatusText(mStatusText);
        viewFinderView.setStatusMargin(mStatusMargin);
        ...
        viewFinderView.setTopViewFinder(mViewFinderMarginTop);
        viewFinderView.setWidthViewFinder(mViewFinderWidth);
        viewFinderView.setHeightViewFinder(mViewFinderHeight);
