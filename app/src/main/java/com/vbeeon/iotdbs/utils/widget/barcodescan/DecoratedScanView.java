...
public class DecoratedScanView extends BarcodeScannerView {
    private static final String TAG = "DecoratedScanView";
    ...
    public DecoratedScanView(Context context) {
        super(context);
        initMultiFormatReader();
    }

    public DecoratedScanView(Context context, AttributeSet attributeSet) {
