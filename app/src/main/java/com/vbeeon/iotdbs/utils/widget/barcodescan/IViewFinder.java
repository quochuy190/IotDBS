...
public interface IViewFinder {
    ...
    void setWidthViewFinder(int mViewFinderWidth);
    void setHeightViewFinder(int mViewFinderWidth);

    void setBorderLineMargin(int mBorderMargin);

    void setStatusSize(float mStatusSize);

    void setStatusColor(int mStatusColor);

    void setStatusMargin(int mStatusMargin);

    void setStatusText(String mStatusText);
}
