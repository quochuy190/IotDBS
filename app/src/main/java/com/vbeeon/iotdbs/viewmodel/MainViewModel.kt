...
//                    "12h 30 tự động tắt đèn khu làm việc tầng 1", "Tắt đèn tầng 1", true, listSW, 1, 1))
    ...
    fun updateNamePantry() = scope.launch(Dispatchers.IO) {
        ...
        val mListSubSW: MutableList<SwitchDetailEntity> = ArrayList()
        val mListSWInsert: MutableList<SwitchEntity> = ArrayList()
        val mListSubSWInsert: MutableList<SwitchDetailEntity> = ArrayList()
        ...
        mListSW.add(SwitchEntity("SW00575", 9, "P.Làm việc T2 trái", false, 3, 2, "Phòng làm việc"))
        mListSubSW.add(SwitchDetailEntity("SW00575sw1", "SW00575", "Dãy thứ 5", "sw1", false, 0, 2))
        mListSubSW.add(SwitchDetailEntity("SW00575sw2", "SW00575", "Quạt gió", "sw2", false, 1, 2))
        mListSubSW.add(SwitchDetailEntity("SW00575sw3", "SW00575", "Dãy thứ nhất", "sw3", false, 0, 2))
        repository.updateList(mListRoom)
        repositorySwitch.updateList(mListSW)
        repositorySubSwitch.updateList(mListSubSW)
        repositorySwitch.delete("SW00584")
        repositorySwitch.delete("SW00581")
        repositorySwitch.delete("SW00572")
        repositorySubSwitch.delete("SW00584")
        repositorySubSwitch.delete("SW00581")
        repositorySubSwitch.delete("SW00572")

        mListSWInsert.add(SwitchEntity("SW00573", 1, "P.Làm việc T1 trên", false, 2, 1, "Phòng làm việc"))
        mListSWInsert.add(SwitchEntity("SW00583", 1, "P.Làm việc T1 dưới", false, 2, 1, "Phòng làm việc"))
        mListSWInsert.add(SwitchEntity("SW00567", 9, "P.Làm việc T2 phải", false, 2, 2, "Phòng làm việc"))
        repositorySwitch.insertList(mListSWInsert)
        Thread.sleep(500)
        mListSubSWInsert.add(SwitchDetailEntity("SW00573sw1", "SW00573", "Hành lang", "sw1", false, 0, 1))
        mListSubSWInsert.add(SwitchDetailEntity("SW00573sw2", "SW00573", "Dãy thứ nhất", "sw2", false, 0, 1))
        mListSubSWInsert.add(SwitchDetailEntity("SW00573sw3", "SW00573", "Dãy thứ hai", "sw3", false, 0, 1))
        mListSubSWInsert.add(SwitchDetailEntity("SW00583sw1", "SW00583", "Dãy thứ ba", "sw1", false, 0, 1))
        mListSubSWInsert.add(SwitchDetailEntity("SW00583sw2", "SW00583", "Quạt gió", "sw2", false, 0, 1))
        mListSubSWInsert.add(SwitchDetailEntity("SW00583sw3", "SW00583", "Dãy thứ tư", "sw3", false, 1, 1))
        //
        mListSubSWInsert.add(SwitchDetailEntity("SW00567sw1", "SW00567", "Dãy thứ hai", "sw1", false, 0, 2))
        mListSubSWInsert.add(SwitchDetailEntity("SW00567sw2", "SW00567", "Dãy thứ ba", "sw2", false, 0, 2))
        mListSubSWInsert.add(SwitchDetailEntity("SW00567sw3", "SW00567", "Dãy thứ tư", "sw3", false, 0, 2))
        repositorySubSwitch.insertList(mListSubSWInsert)
    }
