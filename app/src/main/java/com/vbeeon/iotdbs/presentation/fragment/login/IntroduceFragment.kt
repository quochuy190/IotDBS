...
//                this.launchActivity<LoginActivity>()
    ...
    private fun initDataLocal() {
        ...
        roomSwitch.add(SwitchEntity("SW00575", 9, "P.Làm việc T2", false, 3, 2, "Phòng làm việc"))
        ...
        subSwitch.add(SwitchDetailEntity("SW00575sw3", "SW00575", "Đèn hành lang T2", "sw3", false, 0, 2))
